...
const barChartsParams = {
  series: [
    { data: [3, 4, 1, 6, 5], label: 'Passed' },
    { data: [4, 3, 1, 5, 8], label: 'Penidng' },
    { data: [4, 2, 5, 4, 1], label: 'Rejected' },
  ],
  height: 400,
};
const lineChartsParams = {
  series: [
    { data: [3, 4, 1, 6, 5], label: 'Passed', area: false, stack: 'total' },
    { data: [4, 3, 1, 5, 8], label: 'Pending', area: false, stack: 'total' },
    { data: [4, 2, 5, 4, 1], label: 'Rejected', area: false, stack: 'total' },
  ],
